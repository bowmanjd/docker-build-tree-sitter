...
ARG NODE_VERSION=20
ARG TREE_SITTER_GRAMMAR_GIT_URL=https://github.com/airbus-cert/tree-sitter-powershell.git
# ARG TREE_SITTER_GRAMMAR_GIT_URL=https://github.com/DerekStride/tree-sitter-sql.git
ARG TREE_SITTER_NAME=tree-sitter-powershell
# ARG TREE_SITTER_NAME=tree-sitter-sql
